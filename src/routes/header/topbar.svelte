...
<div class="container flex items-center justify-between h-full px-6 mx-auto text-blue-600 dark:text-blue-300">
	...
	<div class="flex justify-center flex-1 lg:mr-32">
		<div class="relative w-full max-w-xl mr-6 focus-within:text-blue-500">
			...
			<input
				class="w-full py-2 pl-8 pr-2 text-sm text-gray-700 placeholder-gray-600 bg-gray-100 border-0 rounded-md dark:placeholder-gray-500 dark:focus:shadow-outline-gray dark:focus:placeholder-gray-600 dark:bg-gray-700 dark:text-gray-200 focus:placeholder-gray-500 focus:bg-white focus:border-blue-300 focus:outline-none focus:shadow-outline-blue form-input"
				type="text"
	...
	<ul class="flex items-center flex-shrink-0 space-x-6">
		...
		<li class="relative">
			<button
				...
				data-click="toggleNotificationsMenu"
			...
			<template title="isNotificationsMenuOpen">
				<ul
					x-transition-leave="transition ease-in duration-150"
					x-transition-leave-start="opacity-100"
					x-transition-leave-end="opacity-0"
					data-click.away="closeNotificationsMenu"
					data-click="closeNotificationsMenu"
		...
		<li class="relative">
			...
			<template title="isProfileMenuOpen">
				<ul
					x-transition-leave="transition ease-in duration-150"
					x-transition-leave-start="opacity-100"
					x-transition-leave-end="opacity-0"
					data-click.away="closeProfileMenu"
					data-click="closeProfileMenu"
